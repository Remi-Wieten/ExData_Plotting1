...
with(power_new, plot(Date_Time, Global_active_power, xlab = "", ylab = "Global Active Power", type = "l"))                                       ## This plot is the same as plot 2.

with(power_new, plot(Date_Time, Voltage, xlab = "datetime", type = "l"))
...
legend("topright", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = 1, bty = "n")       ## This plot is the same as plot 3.

with(power_new, plot(Date_Time, Global_reactive_power, xlab = "datetime", type = "l"))
